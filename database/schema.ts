...
export class OrganizationUserSchema extends BaseModel {
  static $columns = ['id', 'orgId', 'profileId', 'employeeCode', 'fullName', 'gender', 'phone', 'dateOfBirth', 'companyEmail', 'passwordHash', 'sendWelcomeMail', 'isActive', 'createdAt', 'updatedAt'] as const
