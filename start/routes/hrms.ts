...
export default function hrmsRoutes() {
  ...
  router
    .group(() => {
      ...
      }).use(middleware.hrmsAddon('Settings - Company'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/divisions/:id/assign', [HrmsSettingsController, 'divisionsAssign']).as('hrms.divisions.assign')
        router.patch('/organization/settings/divisions/:id/toggle',[HrmsSettingsController, 'divisionsToggle']).as('hrms.divisions.toggle')
      }).use(middleware.hrmsAddon('Settings - Divisions'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/locations/:id/assign', [HrmsSettingsController, 'locationsAssign']).as('hrms.locations.assign')
        router.patch('/organization/settings/locations/:id/toggle',[HrmsSettingsController, 'locationsToggle']).as('hrms.locations.toggle')
      }).use(middleware.hrmsAddon('Settings - Locations'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/departments/:id/assign', [HrmsSettingsController, 'departmentsAssign']).as('hrms.departments.assign')
        router.patch('/organization/settings/departments/:id/toggle',[HrmsSettingsController, 'departmentsToggle']).as('hrms.departments.toggle')
      }).use(middleware.hrmsAddon('Settings - Departments'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/sub-departments/:id/assign', [HrmsSettingsController, 'subDepartmentsAssign']).as('hrms.sub-departments.assign')
        router.patch('/organization/settings/sub-departments/:id/toggle',[HrmsSettingsController, 'subDepartmentsToggle']).as('hrms.sub-departments.toggle')
      }).use(middleware.hrmsAddon('Settings - Sub Department'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/designations/:id/assign', [HrmsSettingsController, 'designationsAssign']).as('hrms.designations.assign')
        router.patch('/organization/settings/designations/:id/toggle',[HrmsSettingsController, 'designationsToggle']).as('hrms.designations.toggle')
      }).use(middleware.hrmsAddon('Settings - Designations'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/grades/:id/assign', [HrmsSettingsController, 'gradesAssign']).as('hrms.grades.assign')
        router.patch('/organization/settings/grades/:id/toggle',[HrmsSettingsController, 'gradesToggle']).as('hrms.grades.toggle')
      }).use(middleware.hrmsAddon('Settings - Grades'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/sections/:id/assign', [HrmsSettingsController, 'sectionsAssign']).as('hrms.sections.assign')
        router.patch('/organization/settings/sections/:id/toggle',[HrmsSettingsController, 'sectionsToggle']).as('hrms.sections.toggle')
      }).use(middleware.hrmsAddon('Settings - Section'))
      ...
      router.group(() => {
        ...
        router.post('/organization/settings/sub-sections/:id/assign', [HrmsSettingsController, 'subSectionsAssign']).as('hrms.sub-sections.assign')
        router.patch('/organization/settings/sub-sections/:id/toggle',[HrmsSettingsController, 'subSectionsToggle']).as('hrms.sub-sections.toggle')
      }).use(middleware.hrmsAddon('Settings - Sub Section'))
      ...
      router.group(() => {
        ...
        router.patch('/organization/settings/holidays/:id/toggle', [HrmsSettingsController, 'holidaysToggle']).as('hrms.holidays.toggle')
      }).use(middleware.hrmsAddon('Settings - Holidays'))
      ...
      router.group(() => {
        ...
        router.patch('/organization/settings/notice-period/:id/toggle', [HrmsSettingsController, 'noticePeriodToggle']).as('hrms.notice-period.toggle')
      }).use(middleware.hrmsAddon('Settings - Notice Period'))
      ...
      router.group(() => {
        ...
        router.patch('/organization/settings/approvals/:id/toggle', [HrmsSettingsController, 'approvalsToggle']).as('hrms.approvals.toggle')
      }).use(middleware.hrmsAddon('Settings - Approvals'))
      ...
      }).use(middleware.hrmsAddon('Settings - Company Documents'))
      ...
      }).use(middleware.hrmsAddon('Settings - Checklists'))
