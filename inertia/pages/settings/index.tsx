...
export default function SettingsIndex({ settingsUser, platform, orgDefaults, users }: Props) {
  ...
  function goSection(key: string) {
    router.get('/settings', { s: key }, { preserveState: false, replace: true })
  }
  ...
  function saveProfile() {
    ...
    router.put('/settings/profile', { fullName: profileName }, {
  ...
  function saveOrgDefaults() {
    setOrgSaving(true)
    router.put('/settings/org-defaults', {
  ...
  function handleEditUser() {
    ...
    router.put(`/settings/users/${editUserTarget.id}`, { fullName: editUserName }, {
  ...
  function handleResetPw() {
    ...
    router.put(`/settings/users/${resetPwTarget.id}/reset-password`, { newPassword: resetPwVal }, {
  ...
  function handleToggle() {
    ...
    router.put(`/settings/users/${toggleTarget.id}/toggle`, {}, {
