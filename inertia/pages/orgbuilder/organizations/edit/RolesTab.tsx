...
export function RolesTab({ org }: Props) {
  ...
  function savePermissions() {
    ...
    setSaving(true)
    router.put(
      `/orgbuilder/organizations/${org.id}/profiles/${selectedProfile.id}/permissions`,
  ...
  function handleAdd() {
    ...
    setAddLoading(true)
    router.post(`/orgbuilder/organizations/${org.id}/profiles`, {
  ...
  function handleEdit() {
    ...
    setEditLoading(true)
    router.put(`/orgbuilder/organizations/${org.id}/profiles/${selectedProfile.id}`, {
  ...
  function handleDelete() {
    if (!selectedProfile) return
    setDelLoading(true)
    router.delete(`/orgbuilder/organizations/${org.id}/profiles/${selectedProfile.id}`, {
      onSuccess: () => {
