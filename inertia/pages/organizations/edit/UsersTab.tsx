...
function UserListTab({ org }: { org: Org }) {
  ...
  function handleAddUser() {
    ...
    setAddLoading(true)
    router.post(`/organizations/${org.id}/users`, {
  ...
  function handleEditUser() {
    ...
    setEditLoading(true)
    router.put(`/organizations/${org.id}/users/${editUser.id}`, {
  ...
  function handleBulkDirect(op: 'activate' | 'deactivate') {
    ...
    router.post(`/organizations/${org.id}/users/bulk`, { ids: selected, operation: op }, {
