    ...
    <>
      ...
      {(stats.nearExpiry || 0) > 0 && (
        <div className="alert alert-warn" style={{ marginBottom: 18 }}>
          ...
          <Link href="/organizations?near_expiry=1" style={{ fontWeight: 700, color: 'var(--warn)', textDecoration: 'underline', marginLeft: 4 }}>
            View all
          </Link>
        </div>
      )}
      ...
      <div className="g4" style={{ marginBottom: 18 }}>
        <QuickAction label="Add Organization" desc="Onboard new client"    ico={<Building2 size={17} />} accent="#0D9488" href="/organizations/create" />
        <QuickAction label="Extend Plan"       desc="Manage subscriptions" ico={<CreditCard size={17} />} accent="#7C3AED" href="/organizations" />
        <QuickAction label="Assign Lead"       desc="Route to owner"       ico={<UserCheck size={17} />}  accent="#0284C7" href="/leads" />
        <QuickAction label="View Analytics"    desc="Charts & insights"    ico={<BarChart2 size={17} />}  accent="#D97706" href="/organizations" />
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 16 }}>
        ...
        <div className="card">
          <div className="card-h">
            ...
            <Link href="/organizations" className="btn btn-ghost btn-sm" style={{ gap: 4 }}>
